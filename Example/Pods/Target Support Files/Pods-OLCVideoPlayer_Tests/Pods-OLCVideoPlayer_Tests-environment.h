...
// OLCVideoPlayer
#define COCOAPODS_POD_AVAILABLE_OLCVideoPlayer
#define COCOAPODS_VERSION_MAJOR_OLCVideoPlayer 0
#define COCOAPODS_VERSION_MINOR_OLCVideoPlayer 1
#define COCOAPODS_VERSION_PATCH_OLCVideoPlayer 0
